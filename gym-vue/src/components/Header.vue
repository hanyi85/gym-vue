        ...
        <div class="row align-items-center">
          <div class="col-lg-12 d-flex justify-content-between align-items-center">
            <div class="logo_container">
              <router-link to="/">練<span>吧</span></router-link>
            </div>
...
.cart-badge {
  ...
  top: -2px;
  right: -2px;
  background-color: #fe4c50; /* 保留一點原本的亮眼色，或是改用 #7a9d96 */
  color: white;
  font-size: 10px;
  width: 18px;
  height: 18px;
  ...
  border: 2px solid #fff; /* 加個白邊會更有質感 */
  font-weight: 700;
}
...
.account_selection {
  ...
  top: 55px !important; /* 與大 Icon 保持距離 */
}
...
.nav-icon-btn {
  ...
  min-height: 44px; /*  跟其他 icon 同高 */
  padding: 0 14px; /*  撐出長方形寬度 */
  background: #f5f5f7;
  display: inline-flex; /*  icon + 文字 水平排列 */
  align-items: center;
  justify-content: center;
  border-radius: 999px; /*  膠囊型圓角 */
  gap: 8px; /*  icon 與文字距離 */
